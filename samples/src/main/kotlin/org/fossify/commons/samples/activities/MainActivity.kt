...
class MainActivity : BaseSimpleActivity() {
    ...
    private fun loadInterstitialAdThenLaunchUI() {
        ...
        InterstitialAd.load(
            this, "ca-app-pub-3940256099942544/1033173712", adRequest, object : InterstitialAdLoadCallback() {
                override fun onAdLoaded(interstitialAd: InterstitialAd) {
                    interstitialAd.fullScreenContentCallback = object : FullScreenContentCallback() {
                        override fun onAdShowedFullScreenContent() {
                            Log.d("----", "onAdShowedFullScreenContent: showing interstitial ad")
                        }
                        override fun onAdDismissedFullScreenContent() {
                            launchMainUI()
                            Log.d("----", "onAdDismissed: dismissed interstitial ad")
                        }


                        override fun onAdFailedToShowFullScreenContent(adError: AdError) {
                            Log.d("----", "onAdFailedToShow: failed to show interstitial ad")
                            launchMainUI()
                        }
                    }
                ...
                override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                    Log.d("----", "onAdFailedToLoad: failed to load interstitial ad")
                    launchMainUI()
                }
            })
    }
    ...
    private fun launchMainUI() {
        setContent {
            AppThemeSurface {
                ...
                MainScreen(
                    openColorCustomization = ::startCustomizationActivity, manageBlockedNumbers = {
                    ...
                    ConfirmationDialog(
                        this@MainActivity, FAKE_VERSION_APP_LABEL, positive = org.fossify.commons.R.string.ok, negative = 0
                    ) {
                        launchViewIntent(DEVELOPER_PLAY_STORE_URL)
                    }
                }, showMoreApps = showMoreApps, openAbout = ::launchAbout, moreAppsFromUs = ::launchMoreAppsFromUsIntent
                )
                AppLaunched()
            }
        }
    ...
    @Composable
    private fun getDonateAlertDialogState() = rememberAlertDialogState().apply {
        DialogMember {
