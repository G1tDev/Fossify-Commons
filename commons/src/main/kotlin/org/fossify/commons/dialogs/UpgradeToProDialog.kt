        ...
        confirmButton = {
            Row(
                ...
                TextButton(
                    ...
                    Text(text = stringResource(id = R.string.more_info),color = Color(0xFFFFDB58))
                }
                TextButton(
                    onClick = alertDialogState::hide,
                    modifier = Modifier.padding(horizontal = SimpleTheme.dimens.padding.medium)
                ) {
                    Text(text = stringResource(id = R.string.later),color = Color(0xFFFFDB58))
                }
                TextButton(
                    onClick = onUpgradeClick andThen alertDialogState::hide,
                ) {
                    Text(text = stringResource(id = R.string.upgrade),color = Color(0xFFFFDB58))
                }
            }
        },
